                                            ...
                                            data && data.map((value, index, arr) => {
                                                return (
                                                    ...
                                                    <div className="col-lg-6">
                                                        ...
                                                        <div className="d-flex align-items-center">
                                                            <img className="flex-shrink-0 img-fluid rounded" src={value.ItemImg} alt style={{ width: 80 }} />
                                                            <div className="w-100 d-flex flex-column text-start ps-4">
                                                                <h5 className="d-flex justify-content-between border-bottom pb-2">
                                                                    <span>{value.EnterDishName}</span>
                                                                   
                                                                    <span className="text-primary"> <i class="fa-solid fa-indian-rupee-sign"></i> {value.EnterPrice}</span>
